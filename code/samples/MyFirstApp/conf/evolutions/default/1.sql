...
create table zoo_model (
  id                        bigint not null,
  name                      varchar(255),
  constraint pk_zoo_model primary key (id))
;
...
drop table if exists zoo_model;
...
drop sequence if exists zoo_model_seq;
