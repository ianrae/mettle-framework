...
public class PresenterGenerator extends CodeGenerator implements ICodeGenerator
{
	...
	public PresenterGenerator(SfxContext ctx, CodeGenBase gen, String baseDir, String filename, EntityDef def, String packageName, String relPath) 
	{
		super(ctx);
